<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 sm:px-6 lg:px-8 py-20">
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="text-gray-400">Intelligent Music Classification</p>
                </div>
                </div>
                <nav class="hidden md:flex gap-8 absolute left-1/2 transform -translate-x-1/2">
                <button class="transition-colors text-green-400">Classify</button>
                <button class="transition-colors text-gray-300 hover:text-green-400">History</button>
                </nav>
                <div class="flex items-center gap-4">
                <span class="text-green-400 font-medium">balucha.norbert</span>
                <button class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all">
    ...
    <div v-if="!loading && history.length === 0" class="text-gray-400">No classifications yet.</div>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div class="lg:text-right flex-shrink-0">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-900 to-emerald-900 rounded-lg border border-green-700">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-up text-green-400">
